...
export default async function DashboardPage() {
  ...
  const regions = cities.length > 0 
    ? cities.map(c => ({ id: c.id, name: c.name, image: c.photoRef || "/images/dest-bali.png" }))
    : [
  ...
  return (
    <div className={styles.page}>
      ...
      <nav className={styles.navbar}>
        ...
        <form action={logout}>
          <button type="submit" title="Logout" style={{ background: "none", border: "none", cursor: "pointer", padding: 0 }}>
        ...
        <section className={styles.section}>
          ...
          {trips.length > 0 ? (
            ...
            <div className={styles.emptyState}>
              <p>You haven&apos;t planned any trips yet. Start your journey today!</p>
            </div>
          )}
        </section>
      </main>
