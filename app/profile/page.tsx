      ...
      <PageContainer width="default">
        <Card padded className="mb-6 sm:p-8">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-[auto_1fr] sm:items-start">
            <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-2xl bg-[linear-gradient(135deg,#0f766e_0%,#14b8a6_100%)] text-3xl font-bold text-white shadow-sm">
